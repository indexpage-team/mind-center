...
//       {/* Main chat area with padding to avoid overlap */}
//       <main className="flex-1 overflow-auto p-4 flex flex-col pt-[80px] pb-[180px]">
//         {conversation.length === 0 && (
//           <div className="flex justify-center space-x-4 my-8">
//             {sections.map((section) => (
//               <button
...
//         {selectedSection && (
//           <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-30 p-4">
//             <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6 relative">
//               <button
//                 onClick={() => setSelectedSection(null)}
//                 className="absolute top-3 right-3 text-gray-400 hover:text-gray-600"
...
//       {/* Fixed Bottom Question Selector and Input */}
//       <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 pt-4 z-20">
//         <div className="px-4 mb-4">
//           <div className="overflow-x-auto whitespace-nowrap pb-2 scrollbar-hide">
//             <div className="inline-flex space-x-2 px-4">
